...
export default function Auth() {
  ...
  return (
    <PageContainer compact bleed className="min-h-[calc(100vh-4rem)] items-center justify-center fade-in">
      <GlassCard
        variant="low"
        padding="p-8 md:p-12"
        className="w-full max-w-md bg-surface-container-low/70 backdrop-blur-xl shadow-[0_0_40px_rgba(255,255,255,0.02)]"
      >
        <ContentSection>
          <div className="text-center flex flex-col gap-3 items-center">
            <div className="w-16 h-16 bg-error-container/10 rounded-full flex items-center justify-center">
              <Flag size={32} className="text-primary-dim" />
            </div>
            <h1 className="text-3xl bg-gradient-to-br from-white to-zinc-400 bg-clip-text text-transparent font-headline font-bold uppercase tracking-tighter">
          ...
          <div className="flex items-center text-center text-on-surface-variant text-sm before:flex-1 before:border-b before:border-outline-variant/15 after:flex-1 after:border-b after:border-outline-variant/15">
          ...
          <form onSubmit={handleAuth} className="flex flex-col gap-4">
            ...
            <KineticButton type="submit" variant="contained" color="primary" disabled={isLoading} className="w-full justify-between py-4 rounded-sm text-base">
          ...
          <p className="text-center text-[0.9rem] text-on-surface-variant">
