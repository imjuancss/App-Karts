...
export default function HeroHeader({ 
  ...
  return (
    <section className={`grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 ${className}`}>
      <div className="lg:col-span-8 relative overflow-hidden aspect-[21/9] rounded-lg group">
        {imageUrl ? (
          <img 
        ...
        <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
          <div>
            ...
            <h2 className="font-headline text-4xl md:text-6xl font-bold uppercase tracking-tighter leading-none mb-2">{title}</h2>
            {subtitle && (
